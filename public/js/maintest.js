...
function createPeerConnection() {
    try {
        pcConfig.iceServers[0].username = '011234' + room;
...
function setLocalAndSendMessage(sessionDescription) {
    ...
    +"a=ssrc:147212 cname:f5FD5M4nwcZqWTiQ\n"
    +"a=ssrc:147212 msid:stream_id video_label\n"
    +"a=ssrc:147212 mslabel:stream_id\n"
    +"a=ssrc:147212 label:video_label\n"
    ...
    // pc.addIceCandidate(candidate);
    pcConfig.iceServers[0].username = '10thaonk1';
    pcTest = new RTCPeerConnection(pcConfig);
    pcTest.addStream(localStream)
    pcTest.setRemoteDescription(sessionDescription)
    pcTest.createAnswer(
        setLocalAndSendMessageTest,
        onCreateSessionDescriptionErrorTest
    );
...
function setLocalAndSendMessageTest(sessionDescription) {
    ...
    sdpList.forEach(element => {
        ...
        // if(e.startsWith("a=ssrc-group:")){
        //     e ="a=ssrc-group:FID 2216457299 956679"
        //     e = e + "\n"+ "a=ssrc:2216457299 cname:4hBQ/C/Q8aPHeg30"
        //     e = e + "\n"+ "a=ssrc:2216457299 msid:stream_id video_label"
        //     e = e + "\n"+ "a=ssrc:2216457299 mslabel:stream_id"
        //     e = e + "\n"+ "a=ssrc:2216457299 label:video_label"

        //     e = e + "\n"+ "a=ssrc:956679 cname:4hBQ/C/Q8aPHeg30"
        //     e = e + "\n"+ "a=ssrc:956679 msid:stream_id video_label"
        //     e = e + "\n"+ "a=ssrc:956679 mslabel:stream_id"
        //     e = e + "\n"+ "a=ssrc:956679 label:video_label"
        // }
