...
function getAnswer(seesion,type) {
    var sdp = ""
    if (!type || type.audio == true & type.video == true)
        sdp = "v=0\n"
            ...
            + "a=rtcp-fb:111 transport-cc\n"
            + "a=fmtp:111 minptime=10;useinbandfec=1\n"
            + "a=ssrc:" + session + "1 cname:f5FD5M4nwcZqWTiQ\n"
            + "a=ssrc:" + session + "1 msid:stream_id video_label\n"
            + "a=ssrc:" + session + "1 mslabel:stream_id\n"
            + "a=ssrc:" + session + "1 label:video_label\n"
            ...
            + "a=ssrc:" + session + "0 cname:f5FD5M4nwcZqWTiQ\n"
            + "a=ssrc:" + session + "0 msid:stream_id video_label\n"
            + "a=ssrc:" + session + "0 mslabel:stream_id\n"
            + "a=ssrc:" + session + "0 label:video_label\n"
    else
        if (type.video)
            sdp = "v=0\n"
                + "o=- 1443513048222864666 2 IN IP4 127.0.0.1\n"
